...
directory = os.path.dirname(sys.argv[1] + '/') #os.path.dirname('/Users/bound_to_love/Downloads/Test02142018/')
...
=======
saver = tf.train.import_meta_graph(sys.argv[0].replace('predictions','miconia-model.meta'))
# Step-2: Now let's load the weights saved using the restore method.
saver.restore(sess, tf.train.latest_checkpoint(sys.argv[0].replace('predictions','./')))
>>>>>>> Cleaned repository
